...
var App = /** @class */ (function () {
    function App() {
        ...
        this.renderCurrent = function () {
            ...
            if (!size)
                size = 100;
            _this.render(_this.selectFamily.selectedIndex, _this.selectVariant.selectedIndex, _this.textInput.value, size, _this.unionCheckbox.checked, _this.filledCheckbox.checked, _this.kerningCheckbox.checked, _this.separateCheckbox.checked, _this.scalingStrokeCheckbox.checked, parseFloat(_this.bezierAccuracy.value) || undefined, _this.selectUnits.value);
        };
        ...
        this.updateUrl = function () {
            ...
            urlSearchParams.set('input-scaling-stroke', String(_this.scalingStrokeCheckbox.checked));
    ...
    App.prototype.init = function () {
        ...
        this.scalingStrokeCheckbox = this.$('#input-scaling-stroke');
        ...
        Object.values(makerjs.unitType).forEach(function (unit) {
            return _this.addOption(_this.selectUnits, unit);
        });
    };
    App.prototype.readQueryParams = function () {
        ...
        var scalingStrokeCheckbox = urlSearchParams.get('input-scaling-stroke');
        ...
        if (separateCheckbox !== '' && separateCheckbox !== null)
            this.separateCheckbox.checked =
                separateCheckbox === 'true' ? true : false;
        if (scalingStrokeCheckbox !== '' && scalingStrokeCheckbox !== null)
            this.scalingStrokeCheckbox.checked =
                scalingStrokeCheckbox === 'true' ? true : false;
                            ...
                            this.filledCheckbox.onchange =
                                this.kerningCheckbox.onchange =
                                    this.separateCheckbox.onchange =
                                        this.scalingStrokeCheckbox.onchange =
    ...
    App.prototype.getGoogleFonts = function (apiKey) {
        ...
        xhr.onloadend = function () {
            ...
            _this.fontList.items.forEach(function (font) {
                return _this.addOption(_this.selectFamily, font.family);
            });
            _this.loadVariants();
            _this.handleEvents();
    ...
    App.prototype.callMakerjs = function (font, text, size, union, filled, kerning, separate, bezierAccuracy, units, scalingStroke) {
    ...
    App.prototype.render = function (fontIndex, variantIndex, text, size, union, filled, kerning, separate, scalingStroke, bezierAccuracy, units) {
        var _this = this;
        var f = this.fontList.items[fontIndex];
        var v = f.variants[variantIndex];
        var url = f.files[v].substring(5); //remove http:
        if (this.customFont !== undefined) {
            this.callMakerjs(this.customFont, text, size, union, filled, kerning, separate, bezierAccuracy, units, scalingStroke);
        }
        else {
            opentype.load(url, function (err, font) {
                _this.callMakerjs(font, text, size, union, filled, kerning, separate, bezierAccuracy, units, scalingStroke);
            });
        }
    };
    return App;
